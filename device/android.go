...
// Auto-generated Android device models

var androidDeviceModels = []string{
	"Samsung GT-I5510M",
	"Samsung GT-I5800L",
	"Samsung SCH-I559",
	"Samsung SCH-i559",
...
var androidSystemVersions = []string{
	"SDK 23",
	"SDK 24",
	"SDK 25",
	"SDK 26",
...
func randomAndroidDevice(uniqueID string) deviceInfo {
	h := hashStr(uniqueID)
	return deviceInfo{
		model:   androidDeviceModels[h%uint64(len(androidDeviceModels))],
